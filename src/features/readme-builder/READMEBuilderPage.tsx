  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-12 px-4 bg-gray-100 dark:bg-[#1e1e1e]">
      ...
      <form className="space-y-4 w-full max-w-lg">
        ...
        {/* Profile Header Builder Section */}
        <div className="p-6 bg-white dark:bg-[#121212] border border-gray-200 dark:border-gray-800 rounded-lg shadow-sm space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-lg font-semibold text-black dark:text-white flex items-center gap-2">
          ...
          {header.enabled && (
            <div className="space-y-6 border-t border-gray-100 dark:border-gray-800 pt-4 transition-all duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="header-name-input" className="block text-xs font-semibold mb-1 text-gray-500 dark:text-gray-400">Full Name</label>
                  <Input
                ...
                <div>
                  <label htmlFor="header-title-input" className="block text-xs font-semibold mb-1 text-gray-500 dark:text-gray-400">Professional Title</label>
                  <Input
                      ...
                      {(header.typingLines || []).map((line, idx) => (
                        <div key={idx} className="flex gap-2 items-center">
                          ...
                          <button
                            ...
                            className="text-red-500 text-xs font-semibold p-1.5 hover:bg-red-555/10 rounded cursor-pointer"
                          >
                            Remove
                          </button>
                        </div>
              ...
              <div>
                <label className="block text-xs font-semibold mb-1 text-gray-500 dark:text-gray-400">Visitor Counter Placement</label>
                <select
                  value={header.visitorPlacement || 'hidden'}
                  onChange={(e) => setHeader({ visitorPlacement: e.target.value as any })}
                  className="w-full md:w-64 text-xs p-2 rounded border border-gray-300 dark:bg-gray-800 dark:text-white dark:border-gray-600"
                >
